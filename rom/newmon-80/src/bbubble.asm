...
first:	db	HIGH (last-first)	; +0: num pages
	...
	db	'U'	; +10: Boot command letter
	db	9	; +11: front panel key
	db	040h	; +12: port, 0 if variable
	db	10000110b,10000011b,10000110b	; +13: FP display ("bUb")
	db	'Bubble',0	; +16: mnemonic string
...
;	HL = BLOCK NUMBER
	...
	CALL	BDREAD		; Call the Read Function
	jmp	hwboot
...
; COMMON ROUTINES
;
; READ/WRITE ROUTINES ARE IN BBLLIB>ACM
